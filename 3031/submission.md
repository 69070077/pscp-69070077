...
```text
import math เพื่อใช้ฟังก์ชั่น  ceil
input รับค่า s คือพื้นที่หมึกขยายตัวต่อหนึ่งวินาที เเละ num คือจำนวนคำร้องจากผู้คน
...
```text
step1 import math เพื่อใช้ฟังก์ชั่น  ceil
step2 รับค่า s คือพื้นที่หมึกขยายตัวต่อหนึ่งวินาที เเละ num คือจำนวนคำร้องจากผู้คน
step3 for loop input พิกัดของบ้านของคนที่ i 
step4 เเสงผลตำตอบคำถามของคนที่ i ว่าบ้านของเขาจะถูกน้ำท่วมในวินาทีที่เท่าใด
...
```text
คล้ายกับเเผนเเรกเเต่ได้ถามเพื่อนที่ทำผ่านเพื่อให้ช่วยดูเเละเเนะนำ
```
...
```text
ช่วยสอนหาวิธีคำนวนเวลา
```

คุณยังทำอะไรด้วยตนเอง

```text
การเขียนโค้ดเบื่องต้น การคิดวิธีการทำลูป การเเสดงผล 
```
