...
รับค่าอุณหภูมิ
รับหน่วยอุณหภูมิ
รับหน่วยอุณหภูมิที่ต้องการเเปลง
output
เเสดงผลค่าอุณหภูมิที่ถูกเเปลงเเล้ว
constrains
ค่าอุณหภูมิเป็นจำนวนจริงเเละหน่วยอุณหภูมิคือ C,K,F,R
```
...
```text
Step 1: รับค่าอุณหภูมิ หน่วยอุณหภูมิเเละหน่วยที่ต้องการเเปลง
Step 2: ตรวจว่า หน่วยอุณหภูมินั้นคืออะไรเเละหน่วยที่ต้องการเเปลงคืออะไร
Step 3: หากตรงกับที่ตั้งเงื่อนไขของเเต่ละหน่วยให้คำนวณตามสูตรเปลี่ยนอุณหภูมินั้นๆ
Step 4: เเสดงผลค่าอุณหภูมิที่ถูกเเปลงค่าตาามที่ต้องการเเล้ว
...
```text
วิธีสุดท้าาายไม่เหมือนเเผนเเรกเพราะ เเผนเเรกจะตรวจว่าหน่วยกับหน่วยที่ต้องการคืออะไร ซึ่งใช้บรรทัดที่มากเกิน
จึงเปลี่ยนเล็กน้อยโดยการเเปลงค่าอุณฟหภูมิที่รับมาให้เป็น เซลเซียส (C) ก่อน จากนั้นเก็บค่าไว้ในตัวเเปรเเละนำไปเข้าเงื่อนไขตรวจหน่วยต้องการเเปลงเพื่อนำไปคำนวณต่อ
```
...
```text
เพื่อตรวจว่าหาก หน่วยเเรก กับ หน่วยที่ต้องการเเปลงเหมือนกันควรจะตอบยังไง
```
...
```text
เพื่อตรวจว่าหากค่าาอุณหภูมิติดลบจะคำนวณได้มั้ย
```
...
```text
หากหน่วยอุณหภูมิที่ใส่ไปเป็นตัวพิมพ์เล็ก การเเสดงก็ควรจะเเสดง 0.0
เนื่องจากเป็นค่าที่ถูกเก็บไว้ในตัวเเปรสำหรับตอบ
```
...
```text
เพื่อนที่ทำผ่านเเล้ว
```

เขาช่วยอะไร

```text
ช่วยบอกวิธีคิดที่สั้นกว่าจากเเบบที่ผมทำซึ่งใช้บรรทัดยยาวเกินควาามจำเป็น เเละบอกจุดที่ผมผิด
```

คุณยังทำอะไรด้วยตนเอง

```text
การเขียนโค้ดของตัวเองตามเเผนที่วางเอาไว้
```
