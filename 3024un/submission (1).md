...
```text
โจทย์ให้ดูว่าถ้าช่วงคะเเนนที่น้อยสุดกับมากสุดห่างกันมากกว่าสองให้เเสดงผล เซอร์ไพส
input รับค่ารวมของคะเนนทั้งหมดเเละรับค่าคะเเนนที่สูงที่สุด
output ควรพิมพ์ "Surprising" เมื่อค่าคะเเนนต่ำสุดเเละสูงสุดห่างกันมากกว่า 2 เเละ ''Not surprising'' เมื่อต่ำกว่าหรือเท่ากับสอง
```
...
```text
อ่านค่าของคะเนนทั้งหมด เเละคะเเนนที่สูงสุด
นำมาคิดหาค่าคะเเนนต่ำสุด
จากนั้นนำไปตรวจว่ามากกว่าสองมั้ย
ก่อนถามเพื่อน วิธีคิดนั้นมาถูกเเล้วติดตรงการคำนวณเพื่อหาค่าความต่องของคะเเนนต่ำสุดเเละมากสุด
```
...
```text
เเตกต่างนิดหน่อยเพราะผิดตรงการคำนวณหาค่าความต่างของคะเนนต่ำสุดเเละสูงสุด
```
...
```text
เพื่อดูว่าจะ Not เซอร์ไพร์สมั้ย
```
...
```text
เพื่อนที่ทำผ่านเเละพี่ TA
```

เขาช่วยอะไร

```text
บอกจุดที่ผผิดตรงการคำนวณหาค่าความต่างของคะเเนน
```

คุณยังทำอะไรด้วยตนเอง

```text
การรับอินพุต เเละการตั้งเงื่อนไขการเเสดงผล
```
