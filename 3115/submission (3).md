...
```text
Input รับเลขจำนวนร้าน
Output ตัวเลขบอกจำนวนร้านที่เปิด 
constraints พิมพ์ออกมาเว้นวรรคเรียงกัน
```
...
```text
Step 1: อ่านจำนวนร้าน
Step 2: สร้างรายการเก็บจำนวนร้านที่เปิดในแต่ละนาทีขนาด 1,441 ช่อง
Step 3: วนลูปอ่านเวลาเปิดและเวลาปิด
Step 4: อ่านรายการนาทีที่ต้องการเช็ก
Step 5: ดึงค่าจำนวนร้านจากรายการตามนาทีที่สั่งเช็ก แล้วพิมพ์ผลลัพธ์ออกมา
ก่อนถามเพื่อน รู้วว่าต้องสร้างรายการมาคอยบวกสะสมเวลาในแต่ละนาที แต่ยังไม่แน่ใจว่าเวลาปิดจะนับรวมไปด้วยป่าว
```
...
```text
อธิบายโลจิกข้อนี้ เเละคคอยสอน
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดเองเเเละวิเคราะห์โจทย์ตามโลจิกที่เพื่อนคอยสอน
```
