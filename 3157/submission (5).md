...
```text
input รับค่า num มา เพื่อรับค่าเครื่องหมาย + , - 
output เเสดงคะเเนนทั้งหมดหลังจากคำนวน
```
...
```text
รับค่า num เพื่อลูปรับเครื่องหมายตาม num ครั้ง
ใช้ .join() เพื่อรวบเป็นคำเดียว
จากนั้นเเยกจำนวน +, - ด้วย .count() เเละคูณค่าตามกำหนด
ทำค่าที่ได้มาหาผลโดยนำค่าบวกลบด้วยค่าลบ
```
