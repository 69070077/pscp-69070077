...
```text
input รับค่าจำนวนจริงมา 
output ควรพิมพ์ตัวเลขที่ถูกหารสิบไปเรื่อยๆจนเหลือ 0 ในบรรทัดเดียวกัน
...
```text
step1 รับค่าจำนวนเต็ม เเละะนำไปเข้าาwhile loop
step2 ทำการนำค่าหาร 10 เเละเเสดงผล
step3 นำค่าที่รับมาตอนเเรกไป -= 1 เเละวนลูป
step4 เเสดงผล 0 เพราะโค้ดในลูปจะเเสดงผลถึงค่าสุดท้ายคือ 10
...
```text
คล้ายกับเเผนเเรกเเต่ได้ถามเพื่อนที่ทำผ่านเพื่อให้ช่วยดุเเละเเนะนำ
```
...
```text
เผื่อตรวจว่าหากจำนวนหาร10ไม่ลงตัวจะเป็นไง
```
...
```text
ช่วยบอกว่าควรทำอย่างไรให้คำตอบออกมาบรรทัดเดียวกัน 
```
