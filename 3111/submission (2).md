...
```text
input รับข้อความว่าเป็นสมาชิกมั้ย เเละรับจำนวนของที่ซื้อ เเละรับราคา n ครั้งตามจำนวนทีี่ซื้อฃ
output เเสดงราคาที่คำนวณเเล้ว
...
```text
เพิ่มการใช้ round เเละการเเก้ทศนิยมเพื่อให้คิดได้ถูกต้อง
```
...
```text
เพื่อดูว่าถ้าใส่อย่างอื่นนอกจาก Y , N  จะเป็นไง
```
...
```text
การใช้ round เเละการเเก้ทศนิยมเพื่อให้คิดได้ถูกต้อง
```

คุณยังทำอะไรด้วยตนเอง

```text
การคิดโลจิก เเละการเขียนโค้ดตามที่ plan ไว้
```
