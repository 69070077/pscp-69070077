...
```
เผื่อดูว่าค่าบริการจะคิดเท่าไหร่หากค่าอาหารน้อยมาก
```
...
```
เผื่อดูว่าตรงกับ testcase ใน ijudge มั้ย
```
...
```
ช่วยเเก้ปัญหาตรงการคำนวณค่า Vat7%
```

คุณยังทำอะไรด้วยตนเอง

```
เริ่มเขียนรับค่า เเละคำนวณค่าาาบริการ
```
