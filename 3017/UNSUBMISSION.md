...
```
"ต้องรับค่า input ซึ้งคือราคารวมของค่าอาหาร จากนั้น นำไปคิดค่าบริการก่อน10% เพื่อให้ได้ค่าบริการ จากนั้นนำค่าอาหารไปรวมกับค่าบริการเเล้วคูณ 7%  จะได้ค่าภาษีมา เเล้วก็นำค่าทั้งสามบวกกันก็จะได้ราคารวมทั้งหมดที่ต้องจ่าย"
```
...
Step 4:ต้องคำนวณหาค่าบริการเเละภาษีเพื่อนำมาหาค่าอาหารที่ต้องจ่ายจริงๆ
Step 5:ส่งใน ijudge เเละให้เพื่อนช่วยตรวจเพื่อความถูกต้อง
```
...
```
ไม่เหมือน เเต่ผลลัพออกมาตรงตามที่โจทย์ต้องการเพราะได้เพื่อนช่วยสอนในจุดที่ไม่เข้าใจ
```
...
```
เพื่อต้องการหาว่า ค่าบริการจะไม่เกิน 1000 มั้ย
```
