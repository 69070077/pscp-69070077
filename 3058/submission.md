...
```text
input รับค่าจำนวนสามจำนวนมาคือ อิฐก้อนเล็ก , ก้อนใหญ่ เเละจำนวน goal
output จำนวนของอิฐก้อนเล็กที่ต้องใช้ เเต่ถ้าอิฐก้อนเล็กไม่พอให้ตอบ -1 
constraints ควรใช้อิฐก้อนใหญ่ให้ได้มากที่สุดก่อนจะใช้อิฐก้อนเล็กเสมอ
```
...
```text
Step 1: คำนวณหาจำนวนการใช้อิฐก้อนใหญ่
Step 2: จานนั้นไปหาอิฐที่เหลือจากการนำจำนวนิฐใหญ่ที่ใช้ลบกับ goal
Step 3: นำจำนวนอิฐที่เหลอไปเปรียบเทียบกับจำนวนอิฐก้อนเล็ก
Step 4: หากอิฐก้อนเล็กมากกว่าหรือเท่ากับให้เเสดงจำนวนอิฐที่ใช้เเต่หากน้อยกว่าให้เเสดง"-1"
...
```text
การคำนวนหาจำนวนอิฐก้อนเล็กที่ต้องใช้
```

คุณยังทำอะไรด้วยตนเอง

```text
การเขียนโค้ดเบื่องต้น การรับอินพุต เเละการคำนวนหาจำนวนอิฐก้อนเล็กที่ต้องใช้
```
