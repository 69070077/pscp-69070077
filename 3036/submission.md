...
```text
input รับหมายเลขห้องที่อยู่
output หาว่าถ้าจะเดินทางไปถึงห้อง 1 จะต้องพังกำแพงน้อยที่สุดกี่กำแพง
constraints ถ้าสามเหลี่ยมชี้ขึ้น (C เป็นเลขคี่) 
            ถ้าสามเหลี่ยมชี้ลง (C เป็นเลขคู่) 
...
```text
step1 รับหมายเลขห้องที่อยู่
step2 หากำแพงน้อยที่สุดกี่กำแพง
step3 หา C จาก หมายเลขห้องที่อยู่
step4 ถ้าสามเหลี่ยมชี้ขึ้น (C เป็นเลขคี่) output =  2 x (R-1)
      ถ้าสามเหลี่ยมชี้ลง (C เป็นเลขคู่) output =  2 x (R-1) - 1
...
```text
ช่วยสอนวิธีคิดเเละ logic
```

คุณยังทำอะไรด้วยตนเอง

```text
การนำวิธีคิดไปคิดต่อเพื่อเขียนโค้ด
```
