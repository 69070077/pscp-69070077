...
```text
input รับข้อความสถานที่มาเเละรับน้ำหนัก
output เเสดงราคาที่คำนวณ 
constraints หกมีสถานที่นอกเหนือจากที่กำหนดให้ เเสดง Error
```
...
```text
รับข้อความมาเเละ split กับรับน้ำหนัก
ใช้ condition เพื่อเช็คสถานที่ เเละคำนวณราคตามที่เเละน้ำหนัก
เเสดงผลราคา หากมีการป้อนสถานที่นอกเหนือจากที่กำหนด ให้เเสดง Error
```
