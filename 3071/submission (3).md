...
```text
input รับค่า 4 ค่าคือ A,B คือช่วงของจำนวนที่จะหาร  d คือ ตัวหาร r คือ จำนวนเศษ
output จำนวนที่หารเเล้วเหลือเศษ r
B > A , r < d
```
...
```text
step 1 รับค่า 4 ค่าคือ A,B คือช่วงของจำนวนที่จะหาร  d คือ ตัวหาร r คือ จำนวนเศษ
step 2 ใช้ for loop เพื่อหาจำนวนที่หารเเล้วเหลือเศษ r
```
...
```text
ช่วยสอนให้เขาใจวิธีคิดคำนวนของข้อนี้
```

คุณยังทำอะไรด้วยตนเอง

```text
เมื่อเข้าใจวิธีคำนวนก็คิดเเผนเเละเขียนโค้ดตามเเผน
```
