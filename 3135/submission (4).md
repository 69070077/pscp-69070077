...
```text
input รับค่ามา 3  ค่าในหนึ่งบรรทัด
output เเสดงจำนวนคนที่ได้พิจารณาของขวัญ
```
...
```text
รับค่ามาในหนึ่งบรรทัดเเละ split
เช็คก่อนเลยว่าขโมยใช่คนเเรกมั้ย หากใช่ให้เเสดง 1 เเละหยุดรัน หากไม่ก็ไปต่อ
กำหนดตำเเหน่งปัจจุบัน เเละจำนวนคนที่ได้ถือของขวัญ
ใช้ while loop 
คำนวณหาคนต่อไปที่จะได้ของขวัญ
ถ้าคนถัดไปคือ คนแรก หยุดเลย
ถ้าคนถัดไปคือ ขโมย บวกนับเพิ่มอีก 1 คนแล้วหยุดทำงาน
ถ้าไม่เข้าเงื่อนไขบวกเพิ่มอีก 1 คน เปลี่ยนตำแหน่งปัจจุบันเป็นคนถัดไป แล้วทำรอบต่อไป
...
```text
ของขวัญมาที่คนเเรก ก่อนถึงขโมย
```
...
```text
ช่วยสอนเเละใบ้วิธีการคำนวณหาคนถัดไปที่จะได้ของขวัญ
```

คุณยังทำอะไรด้วยตนเอง

```text
การเขียนรับค่า การทำลูป  คิดโลจิกเบื้องต้นเอง
```
